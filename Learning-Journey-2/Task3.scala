object Task3{
    def main(args: Array[String]): Unit = {
        def sum_arrays(array_1:Array[Double],array_2:Array[Double]):Array[Double]={
            ...
            } //Using tailrecursion to form a function loop to calulate the sum of two arrays
            tail_Recursion(array_1,array_2,0,Array())
            }
        val array_1= Array[Double](2,4,6) //array 1
        val array_2= Array[Double](1,3,5) // array 2
